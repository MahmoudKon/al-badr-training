<div class="card-body">
    ...
    <div class="form-group mb-3">
        <label class="form-label required">@lang('units.name')</label>
        <div class="input-icon">
            <input type="text" value="{{ $row->name ?? '' }}" name="name" class="form-control" placeholder="@lang('units.name')" autofocus>

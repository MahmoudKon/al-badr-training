<div class="card-body">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="form-group mb-3">
                <label class="form-label required">@lang('items.price')</label>
                <div class="input-icon">
                    <input type="text" value="{{ $row->sale_price ?? old('sale_price') }}" name="price" class="form-control" placeholder="@lang('items.sale_price')" autofocus>
                    <span class="input-icon-addon"> <i class="fa-solid fa-list"></i> </span>
                </div>
        ...
        <div class="col-md-8">
            <div class="form-group mb-3">
                ...
                <textarea name="description" class="form-control" placeholder="@lang('items.desc')" rows="10">{{ $row->desc ?? old('desc') }}</textarea>
